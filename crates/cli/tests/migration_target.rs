...
"#,
    ...
    assert_eq!(validated["target_id"], "cli-target");
    ...
    assert_eq!(added["descriptor_json"]["safety"]["allow_network"], false);
    ...
    assert!(String::from_utf8_lossy(&contradiction.stderr)
        .contains("target_id conflicts with descriptor.target_id"));
}
