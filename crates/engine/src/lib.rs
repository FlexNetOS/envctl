...
pub mod db_atomic; // GH#414: temp-fsync-rename-reread-hash atomic edit + .bak   [ARCH08]
pub mod db_components; // GH#414: managed-tool inventory + PATH/nix detection    [NFR05/ARCH10]
...
pub use agent::{
    AgentAddSpec, AgentAuditIssue, AgentAuditReport, AgentAuditSpec, AgentCatalogReport,
    AgentCatalogSpec, AgentCleanSpec, AgentCommandAudit, AgentCommandDirCheck,
    AgentCommandTargetAudit, AgentDoctorReport, AgentDoctorSpec, AgentEditItem, AgentEditOutcome,
    AgentInitOutcome, AgentInitSpec, AgentList, AgentListKind, AgentListSpec, AgentLockDriftItem,
    AgentLockMode, AgentLockOutcome, AgentLockSpec, AgentMcpAudit, AgentMcpTargetAudit,
    AgentRemoveSpec, AgentReport, AgentScope, AgentSectionSel, AgentSkillAudit,
    AgentSkillTargetAudit, AgentSyncSpec, AgentUpdateCheck, AgentVerb,
};
pub use catalog::{
...
pub use db_atomic::atomic_backup_write;
pub use db_components::{
    detect as db_components_detect, ComponentsReport, ManagedTool, ToolDetection, INVENTORY,
};
pub use db_deploy::{DeployDisposition, DeployPlan, DeploySpec, DeployStep};
pub use db_index::{DbFileRow, DbIndexStore, FileIndex, ScanScope};
