...
- Codex runtime config: `/home/flexnetos/meta/var/lib/codex/config.toml`.
- Codex operating rules: `/home/flexnetos/meta/var/lib/codex/RULES.md`.
- RTK policy: `/home/flexnetos/meta/var/lib/codex/AGENTS.rtk.md` and
...
change through `/home/flexnetos/meta/var/lib/codex` or envctl `agent-env.yaml`.
