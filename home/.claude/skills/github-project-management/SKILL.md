...
bunx claude-flow@alpha hooks pre-task --description "Feature implementation"
```
...
bunx ruv-swarm github board-init \
...
bunx ruv-swarm github board-sync \
  --map-status '{
    "todo": "To Do",
    "in_progress": "In Progress",
    "review": "Review",
...
bunx ruv-swarm github board-realtime \
...
# Process with swarm
bunx ruv-swarm github board-import-issues \
  --issues "$ISSUES" \
...
bunx ruv-swarm github board-auto-assign \
...
bunx ruv-swarm github board-smart-move \
  --rules '{
...
bunx ruv-swarm github board-bulk \
...
bunx ruv-swarm github sprint-manage \
  --sprint "Sprint 23" \
  --auto-populate \
  --capacity-planning \
  --track-velocity
...
bunx ruv-swarm github milestone-track \
...
```bash
# Setup agile board
bunx ruv-swarm github agile-board \
  --methodology "scrum" \
  --sprint-length "2w" \
...
```bash
# Setup kanban board
bunx ruv-swarm github kanban-board \
  --wip-limits '{
    "In Progress": 5,
    "Review": 3
  }' \
...
bunx ruv-swarm github board-analytics \
...
bunx ruv-swarm github board-progress \
  --show "burndown,velocity,cycle-time" \
  --time-period "sprint" \
  --export-metrics

# Generate reports
bunx ruv-swarm github board-report \
  --type "sprint-summary" \
  --format "markdown" \
...
bunx ruv-swarm github board-kpis \
  --metrics '[
    "average-cycle-time",
...
bunx ruv-swarm github team-metrics \
  --board "Development" \
  --per-member \
...
bunx ruv-swarm github release-plan-board \
  --analyze-velocity \
  --estimate-completion \
  --identify-risks \
  --optimize-scope
...
bunx ruv-swarm github multi-board-sync \
...
bunx ruv-swarm github cross-org-sync \
...
bunx ruv-swarm github board-distribute \
...
bunx ruv-swarm github standup-report \
  --team "frontend" \
...
bunx ruv-swarm github review-coordinate \
  --board "Code Review" \
  --assign-reviewers \
  --track-feedback \
  --ensure-coverage
...
bunx ruv-swarm github board-diagnose \
...
bunx ruv-swarm github board-optimize \
  --analyze-size \
  --archive-completed \
  --index-fields \
  --cache-views
...
```bash
# Recover board data
bunx ruv-swarm github board-recover \
...
bunx ruv-swarm github issue-init $ISSUE_NUM \
  --topology mesh \
  --auto-decompose \
...
# 5. Monitor progress
bunx ruv-swarm github issue-progress $ISSUE_NUM \
...
bunx ruv-swarm github issue-init <number>
bunx ruv-swarm github issue-decompose <number>
bunx ruv-swarm github triage --unlabeled

# Project Boards
bunx ruv-swarm github board-init --project-id <id>
bunx ruv-swarm github board-sync
bunx ruv-swarm github board-analytics

# Sprint Management
bunx ruv-swarm github sprint-manage --sprint "Sprint X"
bunx ruv-swarm github milestone-track --milestone "vX.X"

# Analytics
bunx ruv-swarm github issue-metrics --issue <number>
bunx ruv-swarm github board-kpis
```
