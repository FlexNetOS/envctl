...
| A3 | Accidental git commit | Info | Real keys never enter a `.env`/child env/repo; vault file is ciphertext; daemon stores under `$META_ROOT/var/lib` (0700), outside repos [9,3,12] |
