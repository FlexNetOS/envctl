...
3. **F11 — DONE (TASK-0034)** — `cargo +1.88.0 check --workspace --locked` is a CI job; the
   lockfile pins transitive patches that drifted above Rust/Cargo 1.88. `--all-features` is
