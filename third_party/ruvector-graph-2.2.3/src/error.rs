...
impl From<bincode_reloaded::error::EncodeError> for GraphError {
    fn from(err: bincode_reloaded::error::EncodeError) -> Self {
        GraphError::SerializationError(err.to_string())
    }
}

impl From<bincode_reloaded::error::DecodeError> for GraphError {
    fn from(err: bincode_reloaded::error::DecodeError) -> Self {
        GraphError::SerializationError(err.to_string())
    }
}
