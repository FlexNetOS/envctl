    ...
    for chr in job.text[byte_range.clone()].chars() {
        if job.break_on_newline && chr == '\n' {
            ...
            paragraph.glyphs.push(Glyph {
                ...
                line_height,
                font_impl_height: current_font_face_metrics.row_height,
                font_impl_ascent: current_font_face_metrics.ascent,
    ...
    loop {
            ...
            || row.glyphs.is_empty()
        {
            ...
            row.glyphs.push(Glyph {
                ...
                line_height,
                font_impl_height: font_face_metrics.row_height,
                font_impl_ascent: font_face_metrics.ascent,
                font_height: font_metrics.row_height,
                font_ascent: font_metrics.ascent,
