...
///        FontData::from_static(my_font_bytes)
///    )
/// );
///
...
impl Fonts {
    ...
    pub fn new(
        ...
        Self::new_with_options(
            TextOptions {
                max_texture_side,
                alpha_from_coverage: text_alpha_from_coverage,
                font_hinting: true,
            },
            definitions,
        )
    ...
    pub(crate) fn new_with_options(options: TextOptions, definitions: FontDefinitions) -> Self {
        Self {
            fonts: FontsImpl::new_with_options(options, definitions),
    ...
    pub fn begin_pass(
        ...
        self.begin_pass_with_options(TextOptions {
            max_texture_side,
            alpha_from_coverage: text_alpha_from_coverage,
            font_hinting: true,
        });
    ...
    fn begin_pass_with_options(&mut self, options: TextOptions) {
...
impl FontsImpl {
    ...
    pub(crate) fn new_with_options(options: TextOptions, definitions: FontDefinitions) -> Self {
        ...
        let atlas = TextureAtlas::new_with_options([texture_width, initial_height], options);
...
mod tests {
    ...
    fn test_split_paragraphs() {
        for pixels_per_point in [1.0, 2.0_f32.sqrt(), 2.0] {
            let mut fonts =
                FontsImpl::new_with_options(TextOptions::default(), FontDefinitions::default());
    ...
    fn test_fallback_glyph_width() {
        let mut fonts = Fonts::new_with_options(TextOptions::default(), FontDefinitions::empty());
