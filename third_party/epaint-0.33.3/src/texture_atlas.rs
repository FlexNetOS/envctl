...
use crate::{AlphaFromCoverage, ColorImage, ImageDelta, TextOptions};
...
impl TextureAtlas {
    ...
    pub(crate) fn new_with_options(size: [usize; 2], options: TextOptions) -> Self {
