...
def main [--json] {
    ...
    let rows = [
        ...
        (rust-toolchain-row runner_rust_toolchain "runner Rust toolchain" "/home/flexnetos/meta/src/flexnetos_runner/rust-toolchain.toml" T032 "runner currently uses a floating stable toolchain.")
        ...
        (tool-row flexnetos_runner_workspace "FlexNetOS runner workspace" runner "0.1.0" "/home/flexnetos/meta/src/flexnetos_runner/Cargo.toml" toml T032 repo_config "workspace.package.version=0.1.0" source_of_truth false "" (sha-file "/home/flexnetos/meta/src/flexnetos_runner/Cargo.toml") parsed public "Runner workspace manifest provides the current runner package version.")
    ]
